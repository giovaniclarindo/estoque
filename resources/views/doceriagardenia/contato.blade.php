...
@section('content')
          ...
          <div class="card-body">
            ...
            <form action="">
              ...
              <div class=" d-grid gap-2 col-5 mx-auto">
                <a href="javascript:void(0)" style="background-color: #4a2d69; color: #fff; margin-top: 10px " class="btn btn-md text-center p-2 ">Enviar</a>
    ...
    <div class="col-12 col-md-6 ">
      ...
      <div class="CTT-contcContatos" id="textoContato" st>
        ...
        <br />
        <h2>E-mail:</h2>
        <p>doceria.gardeniaa@gmail.com</p>
        <br />
        <h2>Redes socias</h2>
