...
@section('content')
          ...
          <div class="card-body">
            ...
            <form action="">
              ...
              <div class=" d-grid gap-2 col-5 mx-auto">
                <a href="javascript:void(0)" style="background-color: #117e37; color: #fff; margin-top: 10px " class="btn btn-md text-center p-2 ">Enviar</a>
    ...
    <div class="col-12 col-md-6 ">
      ...
      <div class="CTT-contcContatos" id="textoContato" st>
        ...
        <br />
        <h2>E-mail:</h2>
        <p>chef.antoniaviana@gmail.com</p>
        <br />
        <h2>Redes socias</h2>
        <div class="imgContato">
          <a href="https://www.facebook.com/Vianajuniorantonia/">
          ...
          <a href="https://instagram.com/chef_antoniava?igshid=YmMyMTA2M2Y=">
          ...
          <a href="https://wa.me/5511945067050?text=Ol%C3%A1%2C+gostaria+de+tirar+uma+duvida%21">
